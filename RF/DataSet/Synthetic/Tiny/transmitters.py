...
class transmitter_mapper(gr.hier_block2):
    def __init__(self, modtype, symvals, txname, samples_per_symbol=2, excess_bw=0.35):
        ...
        self.mod = mapper.mapper(mod1[modtype], symvals,None,None)
        #self.mod =  (0,symvals)
...
class transmitter_bpsk(transmitter_mapper):
    modname = "BPSK"
    def __init__(self):
        transmitter_mapper.__init__(self, "BPSK",
...
transmitters = {
    "discrete":[transmitter_gfsk, transmitter_cpfsk],
    "continuous":[transmitter_fm, transmitter_am, transmitter_amssb]
    }

transmitters_orig = {
    "discrete":[transmitter_bpsk,  transmitter_8psk, transmitter_pam4, transmitter_qam16, transmitter_qam64, transmitter_gfsk, transmitter_cpfsk],
    "continuous":[transmitter_fm, transmitter_am, transmitter_amssb]
    }
